...
fun AudioExtractorSuccessScreen(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = "Your extracted audio track is ready and saved",
                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column {
                                ...
                                Text(
                                    text = "Your extracted audio has been saved to Music / AudioCutter folder.",
