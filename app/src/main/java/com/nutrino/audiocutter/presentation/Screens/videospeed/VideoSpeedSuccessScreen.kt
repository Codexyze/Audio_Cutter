...
fun VideoSpeedSuccessScreen(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = "Your processed video has been saved successfully",
                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column {
                                ...
                                Text(
                                    text = "Your speed-adjusted video has been saved to Music / AudioCutter folder.",
