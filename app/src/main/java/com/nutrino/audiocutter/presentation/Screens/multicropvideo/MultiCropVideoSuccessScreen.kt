...
fun MultiCropVideoSuccessScreen(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = "Your multi-crop video has been saved successfully",
                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column {
                                ...
                                Text(
                                    text = "Your multi-crop video has been saved to Music / AudioCutter folder.",
