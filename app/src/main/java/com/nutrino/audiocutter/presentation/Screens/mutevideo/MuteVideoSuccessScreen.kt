...
fun MuteVideoSuccessScreen(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = "Your video has been saved without audio",
                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column {
                                ...
                                Text(
                                    text = "Your muted video has been saved to Music / AudioCutter folder.",
