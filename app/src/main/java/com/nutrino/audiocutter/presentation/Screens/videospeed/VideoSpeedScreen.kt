package com.nutrino.audiocutter.presentation.Screens.videospeed
...
import com.nutrino.audiocutter.presentation.Navigation.VIDEOSPEEDERRORSTATE
import com.nutrino.audiocutter.presentation.Navigation.VIDEOSPEEDSUCCESSSTATE
...
fun VideoSpeedScreen(
    ...
    val userLimitState by videoSpeedViewModel.userLimitState.collectAsState()
    ...
    if (userLimitState.isLimitReached) {
        ...
        AlertDialog(
            onDismissRequest = { videoSpeedViewModel.resetUserLimitError() },
            title = {
                Row(
            ...
            confirmButton = {
                Button(
                    onClick = {
                        videoSpeedViewModel.resetUserLimitError()
            ...
            dismissButton = {
                TextButton(
                    onClick = { videoSpeedViewModel.resetUserLimitError() }
                ) {
