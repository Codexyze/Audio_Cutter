...
fun AudioMergeSuccessScreen(
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = "Your merged audio file is ready and saved",
                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column {
                                ...
                                Text(
                                    text = "Your merged audio file has been saved to Music / AudioCutter folder.",
